...
import com.johnpickup.garmin.fit.workout.TimeHeartRateWorkoutStep;
...
public class TimeHeartRateStepConverter implements StepConverter {
    ...
    public WorkoutStep convert(Step step) {
        ...
        return new TimeHeartRateWorkoutStep(StepIntensityConverter.convert(step.getStepIntensity()), t, heartRateTarget);
    }
}
